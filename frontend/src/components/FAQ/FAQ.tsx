    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                answer: 'We\'re here to help! Feel free to reach out to our wedding planner Maryla at info@artofperfectionevents.com. We want to make sure you have all the information you need for a wonderful trip!',
            },
        ],
    },
];
            ...
            <div className={styles.faqContainer}>
                {faqGroups.map((group) => (
                    <div key={group.category} className={styles.faqGroup}>
                        <h3 className={styles.faqGroupTitle}>{group.category}</h3>
