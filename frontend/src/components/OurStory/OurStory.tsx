...
const CAROUSEL_IMAGES = [
    { src: '/images/couple/lobby.jpeg', alt: 'Steven and Viktoryia in a grand hotel lobby'},
    { src: '/images/couple/napa-vineyard.jpeg', alt: 'Steven and Viktoryia at Sequoia Grove vineyard in Napa Valley where they got engaged'},
    { src: '/images/couple/hallway.jpg', alt: 'Steven and Viktoryia together in an elegant hallway'},
    { src: '/images/couple/presents.jpeg', alt: 'Steven and Viktoryia celebrating with presents'},
    { src: '/images/couple/outside.jpeg', alt: 'Steven and Viktoryia outdoors together'},
    { src: '/images/couple/spotlight.jpg', alt: 'Steven and Viktoryia in the spotlight'},
    { src: '/images/couple/party.jpeg', alt: 'Steven and Viktoryia at their engagement party in Jersey City'},
];
